...
public:
    ...
    void setZDwgControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzDWG_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzDWG_clicked();
    void on_pushButtonZDwgControl_clicked();
