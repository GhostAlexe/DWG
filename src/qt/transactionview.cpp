                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Dwg from zDwg"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zDwg"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zDwg));
