...
CAmount AmountFromValue(const Value& value)
{
    ...
    if (dAmount <= 0.0 || dAmount > 800000000000.0)
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Dwg features */
        {"dwg", "masternode", &masternode, true, true, false},
        {"dwg", "listmasternodes", &listmasternodes, true, true, false},
        {"dwg", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dwg", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dwg", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dwg", "masternodedebug", &masternodedebug, true, true, false},
        {"dwg", "startmasternode", &startmasternode, true, true, false},
        {"dwg", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dwg", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dwg", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dwg", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dwg", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dwg", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dwg", "mnbudget", &mnbudget, true, true, false},
        {"dwg", "preparebudget", &preparebudget, true, true, false},
        {"dwg", "submitbudget", &submitbudget, true, true, false},
        {"dwg", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dwg", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dwg", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dwg", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dwg", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dwg", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dwg", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dwg", "checkbudgets", &checkbudgets, true, true, false},
        {"dwg", "mnsync", &mnsync, true, true, false},
        {"dwg", "spork", &spork, true, true, false},
        {"dwg", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"dwg", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use dwgd, or the -server option to dwg-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> dwg-cli " + methodname + " " + args + "\n";
}
