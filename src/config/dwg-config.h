/* src/config/Dwg-config.h.  Generated from Dwg-config.h.in by configure.  */
/* src/config/dwg-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.Dwg.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Dwg Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Dwg Core 3.0.6"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "Dwg"
