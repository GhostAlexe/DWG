Contributing to DWG Core
============================

The DWG Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DWG Core project, and is not to be
confused with overall DWG Network Protocol consensus changes.

Whether a pull request is merged into DWG Core rests with the project merge
...
Patches that change DWG consensus rules are considerably more involved than
...
Where a patch set proposes to change the DWG consensus, it must have been
...
The project leader is the release manager for each DWG Core release.
