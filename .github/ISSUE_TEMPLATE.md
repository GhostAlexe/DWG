...
This issue tracker is only for technical issues related to DWG Core.
General DWG questions and/or support requests and are best directed to the [DWG Slack](http://dwe.slack.com).
...
### What version of DWG Core are you using?
